...
export const ROLES = {
  [Role.FE_DEV]: {
    ...
    description: `
Frontend Developers shape how our audiences experience and interact with Hack the North online. Whether it’s working with designers to craft our main website, building modern interactive web apps like our hacker application and attendee dashboard, or brainstorming and launching new initiatives like a component library—you can expect to ship plenty of quality code to tens of thousands of users worldwide, while learning new skills in a supportive team that encourages growth.
    `,
    opportunities: `
...
If you have any other questions about our Frontend team, please email dorian@hackthenorth.com.
    `,
...
- Design, construct, and maintain the services powering Hack the North, including:
...
- Rapidly build and take ownership of new projects from your ideas and requested by other teams to improve Hack the North. In the past, these have included:
...
- Bonus: An understanding of how to build scalable backend services to cater to the Hack the North audience.

If you have any other questions about our Backend team, please email alex.aumais@hackthenorth.com.
`,
  ...
  [Role.DES_TL]: {
    ...
    description: `
As the Design Team Lead at Hack the North, you’ll be responsible for leading a team of Graphic and Product Designers to tackle all aspects of Hack the North’s brand identity. You will guide the design team through everything from establishing our theme for the year to making sure our websites, dashboards, and tools are user-friendly for all attendees. The Design Team Lead will plan out the goals, decisions, and strategies for their team, and ensure that the design team is cross-functional across Hack the North by working closely with the other Team Leads. The Design Team Lead will ensure that all tasks are completed and standards are upheld, all while fostering a tight-knit, cohesive, and fun environment for their designers to grow both personally and professionally.
    `,
    opportunities: `
- Lead a team of 2 Product Designers and 3 Graphic Designers to establish and design all internal and external-facing platforms behind Canada’s biggest hackathon
...
`,
  ...
  [Role.GDES_L]: {
    ...
    description: `
As the Lead Graphic Designer for Hack the North, you will work alongside Product Designers and the Design Team Lead of Hack the North’s design team. Specifically, you will be guiding 2 Graphic Designers in their respective projects, helping with task delegation, mentorship, and support. From our date launch website to social media, you will work on establishing and unifying the brand of Hack the North, being the go-to person for visual work, and ensuring that the Graphic Designers on the design team are able to complete design asset requests on time and at a high quality.

Curious about what designing at Hack the North is like? Read our blog post here: [here](https://bit.ly/3n9NWxL)
    `,
    opportunities: `
- Lead a team of 2 Graphic Designers to establish this year’s theme for Hack the North
...
`,
  ...
  [Role.GDES_ORG]: {
    ...
    description: `
As a Graphic Designer for Hack the North, you will be establishing this year’s theme for Canada’s biggest hackathon. You will be bringing Hack the North’s brand to life on web, mobile, and social media platforms. You will be the go-to person for creating beautiful and polished visual work, whether it’s the Hack the North swag designs, social media assets, or even a short animation for an Instagram post. As a part of the Hack the North Design team, you get to define what someone sees any time they interact with Hack the North.

Curious about what designing at Hack the North is like? Read our blog post here: [here](https://bit.ly/3n9NWxL)
    `,
    opportunities: `
- Establish this year’s theme for Hack the North alongside other Graphic Designers
- Create and experiment with various aspects of design (ex. illustration, motion, typography) to create an impactful brand identity
- Design compelling visual assets for our website and/or mobile offerings, social media accounts, and promotional items (ex. swag, virtual photo booth)
- Work closely with the rest of the Design team to maintain a consistent brand language that is diverse, inclusive and accessible
...
- Be the primary advocate for sponsors' goals and their impact on the hacker experience within the Hack the North team
...
- Develop a strong understanding of Hack the North's brand, and convey it through written content and marketing strategies
...
- Bonus: Have experience using platforms such as Front, Mailjet, Meta Adds, Linktree, etc. to execute marketing campaigns/strategies and platforms such as Tiktok, Capcut and Instagram to edit videos.
  ...
  [Role.FIN_DIR]: {
    ...
    description: `
As one of two Finance Directors on the team, you will be responsible for the budget of Hack the North. From building budgets to negotiating with external vendors, you will be collaborating across the entire organization to ensure the success of our event.
    `,
    opportunities: `
